...
const Testimonial = () => {
    ...
    <p></p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque amet sint quam recusandae id magni commodi tempore nesciunt iste, dicta molestiae dolore, reiciendis excepturi quis vero doloremque est ratione expedita?    <div>
                <p className='text-sm text-primary'>Testimonial</p>
               <h1>What Your Patients Says</h1>
                </div>
                <div>

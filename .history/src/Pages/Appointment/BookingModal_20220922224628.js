...
<input type="text" name=''  className='mt-2' disabled  value={user?.displayName || ''} class="input input-bordered input-md w-full max-w-xs" />

<input type="text"   name=''  className='mt-2' placeholder="Phone Number" class="input input-bordered input-md w-full max-w-xs" />
<input type="email"  name='' className='mt-2' disabled value={user?.email || ''} class="input input-bordered input-md w-full max-w-xs" />

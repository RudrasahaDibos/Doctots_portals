...
<div className="modal">
  <div className="modal-box relative">
    <label for="my-modal-3" className="btn btn-sm btn-circle right-2 top-2">✕</label>
...
<input type="number"  className='mt-2' placeholder="Phone Number" className="input input-bordered input-lg w-full max-w-xs" />
<input type="email"  className='mt-2'  placeholder="Email Address" className="input input-bordered input-lg w-full max-w-xs" />

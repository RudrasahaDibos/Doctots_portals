...
<input type="text" value={format(date,'MMMM d, yyyy ')} className='mt-4' class="input input-bordered input-md w-full max-w-xs" />
...
<input type="text"  className='mt-2' placeholder="Full Name " class="input input-bordered input-md w-full max-w-xs" />

<input type="number"  className='mt-2' placeholder="Phone Number" class="input input-bordered input-md w-full max-w-xs" />
<input type="email"  className='mt-2'  placeholder="Emai l Address"class="input input-bordered input-md w-full max-w-xs" />

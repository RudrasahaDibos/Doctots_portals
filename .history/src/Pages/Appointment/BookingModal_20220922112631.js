...
<input type="text"  className='mt-2' disabled  value={user} class="input input-bordered input-md w-full max-w-xs" />

<input type="number"  className='mt-2' placeholder="Phone Number" class="input input-bordered input-md w-full max-w-xs" />
<input type="email"  className='mt-2' disabled class="input input-bordered input-md w-full max-w-xs" />

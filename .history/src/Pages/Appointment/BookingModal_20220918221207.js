...
<div className="modal">
  <div className="modal-box relative">
    ...
    <h3 className="text-lg font-bold text-primary">{name}</h3>
       <form className='mx-auto px-12 grid grid-cols-1 gap-3' >
...
<input type="Submit"  value='Submit' className="input input-bordered input-md w-full max-w-xs btn btn-primary " />

...
<input type="text" placeholder="Phone Number" className="input input-bordered input-lg w-full max-w-xs" />
<input type="Submit" placeholder="Phone Number" className="input input-bordered input-lg w-full max-w-xs" />
